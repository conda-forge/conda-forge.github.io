...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.h, request.V, true);
		} catch (e) {
...
var author$project$Main$Model = F5(
	function (error, url, key, route, response) {
		return {K: error, ac: key, L: response, R: route, V: url};
	});
var author$project$Main$NotFound = {$: 0};
var author$project$Main$ParsedRoute = function (a) {
	return {$: 1, a: a};
};
var author$project$Main$UrlQuery = F4(
	function (pkg, channel, arch, name) {
		return {aw: arch, aA: channel, ae: name, aR: pkg};
	});
...
var author$project$Main$queryParserUrlQuery = A5(
	elm$url$Url$Parser$Query$map4,
	author$project$Main$UrlQuery,
	elm$url$Url$Parser$Query$string('pkg'),
	elm$url$Url$Parser$Query$string('channel'),
	elm$url$Url$Parser$Query$string('arch'),
...
var author$project$Main$router = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(
			elm$url$Url$Parser$map,
			author$project$Main$ParsedRoute,
			A2(
				elm$url$Url$Parser$questionMark,
				elm$url$Url$Parser$s('artifact.html'),
				author$project$Main$queryParserUrlQuery))
		]));
...
var author$project$Main$parseUrlQuery = function (url) {
	return A2(
		elm$core$Maybe$withDefault,
		author$project$Main$NotFound,
		A2(elm$url$Url$Parser$parse, author$project$Main$router, url));
};
...
var author$project$LibcflibRest$Artifact = F5(
	function (name, version, spec, about, rendered_recipe) {
		return {av: about, ae: name, aU: rendered_recipe, aZ: spec, a3: version};
	});
var author$project$LibcflibRest$ArtifactSpec = F5(
	function (path, pkg, channel, arch, name) {
		return {aw: arch, aA: channel, ae: name, aQ: path, aR: pkg};
	});
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{v: false, ay: r.ay, aD: r.aD, e: r.e, h: r.h, i: r.i, j: r.j, V: r.V}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{ay: elm$http$Http$emptyBody, aD: r.aD, e: _List_Nil, h: 'GET', i: elm$core$Maybe$Nothing, j: elm$core$Maybe$Nothing, V: r.V});
};
var author$project$Main$getArtifact = F4(
	function (pkg, channel, arch, name) {
...
var author$project$Main$artifactFromUrlQuery = function (urlquery) {
	return A4(
		author$project$Main$getArtifact,
		A2(elm$core$Maybe$withDefault, '', urlquery.aR),
		A2(elm$core$Maybe$withDefault, '', urlquery.aA),
		A2(elm$core$Maybe$withDefault, '', urlquery.aw),
		A2(elm$core$Maybe$withDefault, '', urlquery.ae));
};
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var author$project$Main$artifactFromRoute = function (route) {
	if (!route.$) {
		return elm$core$Platform$Cmd$none;
	} else {
		var urlquery = route.a;
		return author$project$Main$artifactFromUrlQuery(urlquery);
	}
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aa: fragment, ab: host, aQ: path, ah: port_, ak: protocol, aS: query};
	});
			...
			case 2:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							R: author$project$Main$parseUrlQuery(url),
							V: url
						}),
					author$project$Main$artifactFromRoute(
						author$project$Main$parseUrlQuery(url)));
			default:
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								L: elm$core$Maybe$Just(response)
							}),
...
var author$project$LibcflibRest$ArtifactAbout = F4(
	function (license, home, summary, description) {
		return {aB: description, aH: home, aK: license, a0: summary};
	});
...
var author$project$LibcflibRest$artifactAboutDecoder = A5(
	elm$json$Json$Decode$map4,
	author$project$LibcflibRest$ArtifactAbout,
...
var author$project$Main$viewDecoded = F3(
	function (decoder, val, htmlMaker) {
		var _n0 = A2(elm$json$Json$Decode$decodeValue, decoder, val);
		if (!_n0.$) {
			var v = _n0.a;
			return htmlMaker(v);
		} else {
...
var author$project$Main$viewArtifact = function (artifact) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(artifact.ae + (' v' + artifact.a3))
					])),
				A2(elm$html$Html$br, _List_Nil, _List_Nil),
				A3(
				author$project$Main$viewDecoded,
				author$project$LibcflibRest$artifactAboutDecoder,
				artifact.av,
				function (about) {
					return A2(
						elm$html$Html$div,
						...
						_List_fromArray(
							[
								elm$html$Html$text(about.a0),
								A2(elm$html$Html$br, _List_Nil, _List_Nil),
								A2(
								elm$html$Html$a,
								_List_fromArray(
									[
										elm$html$Html$Attributes$href(about.aH)
									]),
								_List_fromArray(
									[
										elm$html$Html$text('[website]')
									])),
								elm$html$Html$text(' - ' + about.aK),
								function () {
								var _n0 = about.aB;
								if (!_n0.$) {
									var desc = _n0.a;
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								function () {
								var _n1 = A2(elm$core$Dict$get, 'build', rr.aV);
								if (!_n1.$) {
									var val = _n1.a;
									return A2(
										elm$html$Html$div,
								...
								function () {
								var _n2 = A2(elm$core$Dict$get, 'host', rr.aV);
								if (!_n2.$) {
									var val = _n2.a;
									return A2(
										elm$html$Html$div,
								...
								function () {
								var _n3 = A2(elm$core$Dict$get, 'run', rr.aV);
								if (!_n3.$) {
									var val = _n3.a;
									return A2(
										elm$html$Html$div,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Artifact Errors')
					])),
				A2(
				elm$html$Html$div,
				_List_Nil,
				function () {
					switch (error.$) {
						case 0:
							...
							return _List_fromArray(
								[
									elm$html$Html$text('Bad URL: ' + url)
								]);
						case 1:
							return _List_fromArray(
								[
									elm$html$Html$text('Network timeout')
								]);
						case 2:
							return _List_fromArray(
								[
...
var author$project$Main$viewFooter = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$href('https://conda-forge.org/')
				]),
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$href('https://conda-forge.org/docs/')
				]),
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$href('https://twitter.com/condaforge')
				]),
			_List_fromArray(
				[
...
var author$project$Main$viewHeader = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$text('Conda-Forge')
				]))
		]));
var elm$html$Html$h4 = _VirtualDom_node('h4');
var author$project$Main$viewUrlQuery = function (r) {
	if (!r.$) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('url-query-text-error')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$text('URL query not parsed!')
						]))
				]));
	} else {
		var urlquery = r.a;
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('url-query-text')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$text(
							A2(elm$core$Maybe$withDefault, '<no-pkg>', urlquery.aR) + ('/' + (A2(elm$core$Maybe$withDefault, '<no-channel', urlquery.aA) + ('/' + (A2(elm$core$Maybe$withDefault, '<no-arch>', urlquery.aw) + ('/' + A2(elm$core$Maybe$withDefault, '<no-name>', urlquery.ae)))))))
						]))
				]));
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				author$project$Main$viewUrlQuery(model.R),
				function () {
				var _n0 = model.L;
				if (!_n0.$) {
					var response = _n0.a;
					return author$project$Main$viewArtifact(response);
				} else {
...
var elm$browser$Browser$Document = F2(
	function (title, body) {
		return {ay: body, a1: title};
	});
var author$project$Main$view = function (model) {
	return A2(
		elm$browser$Browser$Document,
		'Conda-Forge Artifact',
		_List_fromArray(
			[
...
var author$project$Main$main = elm$browser$Browser$application(
	{
		...
		aL: author$project$Main$UrlChanged,
		aM: author$project$Main$LinkClicked,
		a$: function (_n0) {
			return elm$core$Platform$Sub$none;
		},
		a2: author$project$Main$update,
		a4: author$project$Main$view
	});
