...
For more information on pinning, please refer to [Pinned dependencies](pinning_deps.mdx#pinned-deps).
...
Moved to [Jinja templating](/docs/maintainer/understanding_conda_forge/jinja-templating/).
