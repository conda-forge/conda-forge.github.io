...
2. Host requirements contained in the [conda-forge pinnings](pinning_deps.mdx#pinned-deps) should be _name-only_; i.e. they do not specify a separate version.
...
2. If ABI compatibility is important for the package, `run_exports` are set accordingly.
   See [Pinned dependencies](pinning_deps.mdx#pinned-deps) and the [conda-build docs](https://docs.conda.io/projects/conda-build/en/stable/resources/define-metadata.html#export-runtime-requirements) for more information.
