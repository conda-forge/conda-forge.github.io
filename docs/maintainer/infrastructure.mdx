...
- 🤖 Integrated with [`admin-migrations`](#admin-migrations), [`admin-requests`](#admin-requests), the [`conda-forge-bot`](#conda-forge-bot), and [`webservices`](#webservices).
...
- `.ci_support/migrations/`: Special YAML files that instruct `conda-smithy` how to update the `.ci_support/*.yaml` files. These migration files are usually put here by the [`conda-forge-bot`](#conda-forge-bot) infrastructure, and removed once the migration is considered finished.
...
This is the graph data used by [`conda-forge-bot`](#conda-forge-bot).

- ⚙️ Deployed in [Github Actions via `conda-forge/conda-forge-bot-data`](https://github.com/conda-forge/conda-forge-bot-data)
- ⛓ Needs [`conda-forge/conda-forge-bot`](#conda-forgeconda-forge-bot), [`conda-forge/conda-forge-pinning-feedstock`](#conda-forge-pinning)
- 🤖 Uses [`@regro-cf-autotick-bot`](#bot-accounts)
- 🔒 Has access to Github API

The logic to build the graph is provided by [`conda-forge-bot`](#conda-forgeconda-forge-bot).
...
#### conda-forge/conda-forge-bot

The code and logic behind [`conda-forge-bot`](#conda-forge-bot).

- 📜 Source at [`conda-forge/conda-forge-bot`](https://github.com/conda-forge/conda-forge-bot)
- 📖 [Documentation](https://github.com/conda-forge/conda-forge-bot/blob/main/README.md)
...
- ⚙️ Deployed in [`conda-forge/conda-forge-bot`](https://github.com/conda-forge/conda-forge-bot)
- ⛓ Needs [`conda-forge/conda-forge-bot`](https://github.com/conda-forge/conda-forge-bot), [`conda-forge/conda-forge-bot-data`](https://github.com/conda-forge/conda-forge-bot-data), [`conda-forge/conda-forge-pinning-feedstock`](https://github.com/conda-forge/conda-forge-pinning-feedstock)
...
the bot now runs directly in `conda-forge/conda-forge-bot`.
:::
...
<a id="conda-forge-admin-please-ping-conda-forge"></a>
...
[here](#automerge).
Please open issue on `conda-forge/conda-forge-bot` for any feedback, bugs, and/or questions!
...
Entering the above phrase in the title of an issue on a feedstock will request the admin bot
to convert the recipe to the v1 format using
[conda-recipe-manager](https://github.com/conda/conda-recipe-manager). You can also use this command
in a comment on a PR. If the conversion fails, the admin bot will post an error message with the
output of the conversion process. Note that the bot might start by opening a PR with only partial
changes. The rest of the contents will be added in a subsequent commit after a few minutes.
...
See [Self-hosted runners](/docs/how-to/advanced/self-hosted-runners/) and [Runners reference](/docs/reference/runners/).
...
- [`regro`](https://github.com/regro): hosts the `conda-forge-bot` machinery
...
:::info
This allows, for example, access to custom runners for Github Actions.
:::
