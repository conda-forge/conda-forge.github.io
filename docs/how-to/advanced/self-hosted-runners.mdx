...
2. In `recipe/conda_build_config.yaml`, use [`github_actions_labels`](/docs/maintainer/conda_forge_yml.mdx#github_actions_labels) to configure the `runs-on` value needed for each platform, using selectors as needed.
