...
"target" to refer to the host platform. This convention is notably used by CMake, but we will not
use this convention in this document.

For more discussion on the various environment types, as well as their names and roles, see
