...
Dec. 2020) to 11.0 (released Nov. 2020, end-of-life since Sept. 2023) in early February 2026.
...
meta-package, which picks up `c_stdlib_version` from our global pinning (unless overridden on the
feedstock in `recipe/conda_build_config.yaml`), and will inject (on OSX) a corresponding constraint
