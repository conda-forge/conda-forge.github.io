...
Services offered: Conda & PyPI Packaging, Cross-platform Build Systems, Reproducible Environments, CI/CD Integration, Developer Tooling, Open Source Support, Training

Contact Info: [hi@prefix.dev](mailto:hi@prefix.dev) ; [https://prefix.dev](https://prefix.dev)

Background / Description: Prefix.dev is the team behind [Pixi](https://pixi.sh) and [Rattler-Build](https://rattler-build.prefix.dev/). We are modernizing the Conda ecosystem to future-proof it, rewriting core components in Rust for reliability and major performance improvements. We focus on reproducible environments, fast cross-platform builds, and developer-friendly tooling across Linux, macOS, and Windows. As active maintainers in the Conda ecosystem, we help teams modernize packaging workflows, design robust build pipelines, and integrate open-source tooling into real-world production setups. We provide hands-on support for packaging desktop applications, low-level libraries, ROS nodes, datasets, AI models, and essentially any kind of software or artifact that needs to be built and distributed. Our work covers Python, C/C++, Rust, robotics (ROS), AI, and scientific computing use cases.
