...
import CoreMembers from '@site/src/core.csv';
import EmeritusMembers from '@site/src/emeritus.csv';
...
to [@conda-forge/core](/community/join/#core). The voting period
...
<Members data={CoreMembers}/>

## Emetirus members

In alphabetical order,

<Members data={EmeritusMembers}/>
