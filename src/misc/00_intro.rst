...
.. glossary::
  ...
  CFEP  
    **C**\ onda **F**\ orge **E**\ nhancement **P**\ roposal. As conda-forge grows, all major changes to the project from a technical standpoint as well as to address social topics such as governance and expected conduct should be submitted as a CFEP. `Learn More <https://conda-forge.org/docs/orga/cfep-index.html#index-of-cfeps/>`_. 
