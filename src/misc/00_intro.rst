...
.. glossary::
  ...
  CLI
    **C**\ ommand **L**\ ine **I**\ nterface. A program in which commands are entered as text, one line at a time, for a computer to execute. This is done in the Anaconda Prompt in Windows, and in a terminal in macOS and Linux. Conda is executed in a CLI. Contrast with Graphical User Interface (GUI) `Learn More <https://en.wikipedia.org/wiki/Command-line_interface>`_.
