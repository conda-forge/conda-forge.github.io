...
<head>
    ...
    <title> Page not found :( | conda-forge</title>
    ...
    <link rel="stylesheet" href="/css/octicons.3.4.1/octicons.css">
            ...
            <div class="container semi-black-alpha">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <p class="intro-text">Sorry, the page you were looking for does not exist.</p>
                    </div>
                </div>
            </div>
        </div>
